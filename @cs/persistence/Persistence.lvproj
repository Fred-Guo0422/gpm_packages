		...
		<Item Name="GPM Packages" Type="Folder">
			...
			<Item Name="@cs" Type="Folder">
				<Item Name="data-type-serializer" Type="Folder">
					...
					<Item Name="CHANGELOG.md" Type="Document" URL="/&lt;vilib&gt;/gpm_packages/@cs/persistence/gpm_packages/@cs/data-type-serializer/CHANGELOG.md"/>
					<Item Name="Data Types.lvproj" Type="Document" URL="/&lt;vilib&gt;/gpm_packages/@cs/persistence/gpm_packages/@cs/data-type-serializer/Data Types.lvproj"/>
					<Item Name="gpackage.json" Type="Document" URL="/&lt;vilib&gt;/gpm_packages/@cs/persistence/gpm_packages/@cs/data-type-serializer/gpackage.json"/>
					<Item Name="LICENSE" Type="Document" URL="/&lt;vilib&gt;/gpm_packages/@cs/persistence/gpm_packages/@cs/data-type-serializer/LICENSE"/>
					<Item Name="README.md" Type="Document" URL="/&lt;vilib&gt;/gpm_packages/@cs/persistence/gpm_packages/@cs/data-type-serializer/README.md"/>
				</Item>
				<Item Name="run-time-assertions" Type="Folder">
					...
					<Item Name="CHANGELOG.md" Type="Document" URL="/&lt;vilib&gt;/gpm_packages/@cs/persistence/gpm_packages/@cs/run-time-assertions/CHANGELOG.md"/>
					<Item Name="gpackage.json" Type="Document" URL="/&lt;vilib&gt;/gpm_packages/@cs/persistence/gpm_packages/@cs/run-time-assertions/gpackage.json"/>
					<Item Name="LICENSE" Type="Document" URL="/&lt;vilib&gt;/gpm_packages/@cs/persistence/gpm_packages/@cs/run-time-assertions/LICENSE"/>
					<Item Name="README.md" Type="Document" URL="/&lt;vilib&gt;/gpm_packages/@cs/persistence/gpm_packages/@cs/run-time-assertions/README.md"/>
				</Item>
			</Item>
		</Item>
